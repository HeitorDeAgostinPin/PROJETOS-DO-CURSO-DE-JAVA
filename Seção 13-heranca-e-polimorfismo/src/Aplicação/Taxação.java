...
public class Taxação {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= c; i++) {
            ...
            System.out.print("É Pessoa Jurídica ou Física? (J/F): ");
            ...
            if (tipo == 'J' || tipo == 'j') {
                ...
                pessoas.add(new Pessoa_Juridica(nome, rendaAnual, numeroFuncionarios));
                ...
                pessoas.add(new Pessoa_Fisica(nome, rendaAnual, gastosSaude));
            }
        }
        ...
        for (Pessoa p : pessoas) {
            double imposto = p.taxa();
            System.out.println(p.getNome() + ": R$ " + String.format("%.2f", imposto));
            soma += imposto;
        }
